...
export class EnvManager {
    ...
    async listEnvVars() {
        ...
        const varGroups = {
            'AI Providers': ['OPENAI_API_KEY', 'ANTHROPIC_API_KEY', 'GEMINI_API_KEY', 'GROQ_API_KEY', 'OPENROUTER_API_KEY'],
...
`;
    ...
    async validateEnvVars() {
        ...
        if (!hasProvider) {
            ...
            console.log(chalk.gray('    sentinel env init'));
            console.log(chalk.gray('    sentinel auth set groq <your-api-key>'));
        } else {
