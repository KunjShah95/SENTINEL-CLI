...
class ChatProvider {
     ...
     */
    constructor(extensionUri, sentinelService, fileOperations, terminalManager) {
    ...
    open() {
        ...
        this.panel = vscode.window.createWebviewPanel('sentinelChat', 'Sentinel AI Chat', vscode.ViewColumn.Two, {
            enableScripts: true,
